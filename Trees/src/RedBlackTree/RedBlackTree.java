...
public class RedBlackTree<T extends Comparable<T>> {
    ...
    public String createOutput(String request, RedBlackTree tree) {
        String output = "";
        if (request == "PRE") {
    ...
    // node
    public String printPre(RedBlackNode<T> n) {
    ...
    public String printPost(RedBlackNode<T> n) {
        //if there's nothing in the node, just return an empty string
        if (n.key == null) {
            return "";
        }
    ...
    public String printIn(RedBlackNode<T> n) {
        //if there's nothing in the node, just return an empty string
        if (n.key == null) {
            return "";
        }
